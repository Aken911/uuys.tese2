...
function mac_url_art_pic($info,$param=[])
{
    return mac_url('art/pic',['page'=>$param['page']],$info);
}
function mac_url_art_book($info,$param=[])
{
    return mac_url('art/book',['page'=>$param['page']],$info);
}
